...
<head>
  ...
  <link rel="canonical" href="https://www.apogeeleveller.com/contact.php" >
...
.allErrorPage .error_section_subtitle {
  color: #25F193;
...
.allErrorPage .error_section .error_title {
  --x-shadow: 0;
  --y-shadow: 0;
  --x:50%;
  --y:50%;
...
.allErrorPage .error_section .error_title:hover {
  transition: all 0.2s ease;
  text-shadow: var(--x-shadow) var(--y-shadow) 10px #1A1A1A;
}
.allErrorPage .error_section .error_title p {
  position: absolute;
  top: 2rem;
  left: 2rem;
...
<div class="allErrorPage">
    <section class="error_section">
      ...
      <a href="index.php" class="btn bgGreen text-white">Back to home</a>
    </section>
</div>
