...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.apogeeleveller.com/image-gallery.php" >
  ...
  <title>Apogee Precision Lasers | Image Gallery</title>
...
<section class="multiMediaSec sectionPadding">
    <div class="container">
      <div class="sectionHead mb-5">
        <h1 class="text-capatalize textGreen ">Our Gallery</h1>
      </div><br>
      <div class="row">
      ...
      <div class="row">
        <div class="col-md-6 mb-3">
          <a href="assets/images/gallery/gnss-Land-leveller.webp" data-toggle="lightbox" data-gallery="gallery">
            <img src="assets/images/gallery/gnss-Land-leveller.webp" class="img-fluid img-thumbnail rounded" alt="GNSS Land Leveller">
          </a>
        </div>
        <div class="col-md-6 mb-3">
          <a href="assets/images/gallery/Laser-Land-Leveller.webp" data-toggle="lightbox" data-gallery="gallery">
            <img src="assets/images/gallery/Laser-Land-Leveller.webp" class="img-fluid img-thumbnail rounded" alt="Laser Land Leveller">
          </a>
        </div>
      </div>
    </div>    
