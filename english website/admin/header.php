 ...
 <!-- <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Leveller</span>
    </a>
    ...
    <div class="sidebar sidebarNavWrap">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">          
          ...
          <li class="nav-item">
            <a href="contactFormQueryList.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>Contact Form Query List</p>
            </a>
          </li>

          <li class="nav-item">
            <a href="stateList.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>State List</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="districtList.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>District List</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="dealerFirmList.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>Dealar Firm List</p>
            </a>
          </li>

          <li class="nav-item">
            <a href="newsletterContactFormList.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>NewsLetter Contact</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="change_password.php" class="nav-link lineHeightOneTwo1">
              <i class="nav-icon fas fa-th"></i>
              <p>Change Password</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="backend/logout.php" class="nav-link lineHeightOneTwo">
              <i class="nav-icon fas fa-th"></i>
              <p>Logout</p>
            </a>
          </li>
