  ...
  if(isset($_POST['but_delete'])){
    if(isset($_POST['contact_query_id'])){
      foreach($_POST['contact_query_id'] as $deleteid){
        $query = $conn->prepare("DELETE FROM newsletter_contact where id = :id ");
          ...
          <div class="container-fluid">
            ...
            <div class="row mb-1">
              ...
              <div class="page-title-box">
                  <h4 class="mb-sm-0 font-size-18">Newsletter Contact List</h4>
              </div>                      
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                  <li class="breadcrumb-item active">Newsletter Contact List</li>
                </ol>
              </div>
            </div>
          </div>
                                      ...
                                      foreach ($result as $value) {
                                        ...
                                        <tr draggable='true' ondragstart='start()' ondragover='dragover()'>
                                          ...
                                          <td>
                                              ...
                                              <a href="backend/newsletterContactFormDelete.php?id=<?php if(!empty($id)){ echo $id; } ?>" onclick="return confirm('Are you sure you want to delete this record?');" class="btn far fa-trash-alt actionDelete" title="Delete Record"></a>
                                          </td>
                                        </tr>
                                        <?php
                                        $sr_no = $sr_no+1;
