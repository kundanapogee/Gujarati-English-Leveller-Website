...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gj.apogeeleveller.com/apogee-dual-si-transmitter.php" >
...
<meta name = "og_url" property = "og:url" content = "https://www.gj.apogeeleveller.com/apogee-dual-si-transmitter.php">

<meta name = "og_image" property = "og:image" content = "https://www.gj.apogeeleveller.com/assets/images/product/transmitter/apogee1stransmitter/apogee-dual-SI-transmitter.webp">
...
<section class="productSectionTop ">
  <div class="container sectionPadding pb-3">
    ...
    <div class="row">
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner thumbnailTop">
              <div class="carousel-item active" data-slide-number="0">
                <img src="assets/images/product/transmitter/apogee1stransmitter/apogee-1s-transmitter.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee1stransmitter/apogee-1s-transmitter.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Apogee 1s Dual SI Transmitter">
              </div>
              <div class="carousel-item" data-slide-number="1">
                <img src="assets/images/product/transmitter/apogee1stransmitter/dual-SI-transmitter.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee1stransmitter/dual-SI-transmitter.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Apogee Dual SI Transmitter">
              </div>
              <div class="carousel-item" data-slide-number="2">
                <img src="assets/images/product/transmitter/apogee1stransmitter/apogee-dual-SI-transmitter.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee1stransmitter/apogee-dual-SI-transmitter.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Apogee 1s Dual SI Transmitter">
              </div>
              ...
              <div class="carousel-item active">
                <div class="row mx-0">
                  <div id="carousel-selector-0" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2 selected" data-target="#myCarousel" data-slide-to="0">
                    <img src="assets/images/product/transmitter/apogee1stransmitter/apogee-1s-transmitter.webp" class="img-fluid" alt="Apogee 1s Dual SI Transmitter">
                  </div>
                  <div id="carousel-selector-1" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
                    <img src="assets/images/product/transmitter/apogee1stransmitter/dual-SI-transmitter.webp" class="img-fluid" alt="Apogee Dual SI Transmitter">
                  </div>
                  <div id="carousel-selector-2" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
                    <img src="assets/images/product/transmitter/apogee1stransmitter/apogee-dual-SI-transmitter.webp" class="img-fluid" alt="Apogee 1s Dual SI Transmitter">
                  </div>
      ...
      <div class="col-md-6">
        <div class="d-blok">
          <h2 class=" textGreen specialFont1" style="font-weight: 600;">એપોજી 1S-Dual SI</h2>
          <p class="textColor">Apogee 1S ટ્રાન્સમીટર, એક ડ્યુઅલ SI રોટેટરી ટ્રાન્સમીટર જે તમને બંને ધરી પર ઉચ્ચ ડિગ્રી સ્લોપ પ્રદાન કરે છે, જે ભારત સરકાર દ્વારા માન્ય છે. આ ડ્યુઅલ એસઆઈ ટ્રાન્સમીટર જે 600 મીટરની વર્કિંગ રેન્જ ધરાવે છે, તેની ખૂબ ભલામણ કરવામાં આવે છે. આ ઈઝ-ઈન હાઉસ ઉત્પાદિત છે અને બજારમાં તમામ પ્રકારની સિસ્ટમ સાથે કામ કરી શકે છે. </p>
          <!-- <div class="row  mt-3">
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              <ul class="specificationList">
                <li class="headList">Apogee 1S-Dual SI ટ્રાન્સમીટર</li>
                <li class="bgGreen"></li>
                <li class="p-0">
                  <table class="table table-bordered mb-0">
                    ...
                    <tr>
                      <td>દ્વિ-માર્ગી વાયરલેસ સંચાર કાર્ય</td>
                      <td>હા</td>
                    </tr>
                    <tr>
