...
<!-- End Google Tag Manager -->
  ...
  <link rel="canonical" href="https://www.gj.apogeeleveller.com/apogee-transmitter-dual-si.php" >
  <link rel="alternate" hreflang="en" href="https://www.apogeeleveller.com/apogee-transmitter-dual-si.php" />
  <link rel="alternate" hreflang="gu" href="https://www.gj.apogeeleveller.com/apogee-transmitter-dual-si.php" />
  <link rel="alternate" hreflang="x-default" href="https://www.apogeeleveller.com/apogee-transmitter-dual-si.php" />


  <title>Apogee Dual SI Laser Transmitter | Laser Land Leveller Equipment</title>
<meta name = "og_title" property = "og:title" content = "Apogee Dual SI Laser Transmitter | Laser Land Leveller Equipment">
...
<meta name = "Description" content = "Apogee’s dual slope laser rotatory transmitter is beneficial to ease land levelling. It is in house manufactured and is highly recommended to work with all systems in the market">
<meta property = "og:description" content = "Apogee’s dual slope laser rotatory transmitter is beneficial to ease land levelling. It is in house manufactured and is highly recommended to work with all systems in the market">

<meta name = "og_url" property = "og:url" content = "https://www.gj.apogeeleveller.com/apogee-transmitter-dual-si.php">

<meta name = "og_image" property = "og:image" content = "https://www.gj.apogeeleveller.com/assets/images/product/transmitter/apogee2stransmitter/apogee-2S-dual-SI-transmitter.webp">
...
<section class="productSectionTop ">
  <div class="container sectionPadding pb-3">
    <div>
      <h1 class="text-capatalize textGreen">ડ્યુઅલ એસઆઈ ટ્રાન્સમીટર</h1>
      <p class="bottom30">બંને ધરી પર ઉચ્ચ ડિગ્રી ઢાળ</p>
    </div>
    <div class="row">
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner thumbnailTop">
              <div class="carousel-item active" data-slide-number="0">
                <img src="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-transmitter.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-transmitter.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Apogee 2s Dual SI Transmitter">
              </div>
              <div class="carousel-item" data-slide-number="1">
                <img src="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-dual-SI-transmitter.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-dual-SI-transmitter.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Dual Si Transmitter">
              </div>
              <div class="carousel-item" data-slide-number="2">
                <img src="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-2.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-2.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery" alt="Apogee Dual SI Transmitter">
              </div>
              <div class="carousel-item" data-slide-number="3">
                <img src="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-3.webp" class="d-block w-100" data-remote="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-3.webp" data-type="image" data-toggle="lightbox" data-gallery="example-gallery">
              </div>                        
            </div>
          </div>
              ...
              <div class="carousel-item active">
                <div class="row mx-0">
                  <div id="carousel-selector-0" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2 selected" data-target="#myCarousel" data-slide-to="0">
                    <img src="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-transmitter.webp" class="img-fluid" alt="Apogee 2s Dual SI Transmitter">
                  </div>
                  <div id="carousel-selector-1" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2" data-target="#myCarousel" data-slide-to="1">
                    <img src="assets/images/product/transmitter/apogee2stransmitter/apogee-2S-dual-SI-transmitter.webp" class="img-fluid" alt="Dual Si Transmitter">
                  </div>
                  <div id="carousel-selector-2" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2" data-target="#myCarousel" data-slide-to="2">
                    <img src="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-2.webp" class="img-fluid" alt="Apogee Dual SI Transmitter">
                  </div>
                  <div id="carousel-selector-3" class="thumb col-4 col-sm-3 col-md-3 col-lg-2 px-1 py-2" data-target="#myCarousel" data-slide-to="3">
                    <img src="assets/images/product/transmitter/apogee2stransmitter/dual-SI-transmitter-3.webp" class="img-fluid">
                  </div>
                </div>
              </div>
      ...
      <div class="col-md-6">
        <div class="d-blok">
          <h2 class=" textGreen specialFont1" style="font-weight: 600;">એપોજી 2S-Dual SI</h2>
          <p class="textColor">એપોજી લેવલર ભારત સરકાર દ્વારા મંજૂર કરાયેલ જમીનના સ્તરીકરણને સરળ બનાવવા માટે કૃષિ માટે ડ્યુઅલ SI રોટેટરી લેસર ટ્રાન્સમીટર પ્રસ્તુત કરી રહ્યું છે. એપોજી નું ડ્યુઅલ-સ્લોપ ટ્રાન્સમીટર તમને બંને ધરી પર ઉચ્ચ ડિગ્રી ઢાળ પ્રદાન કરે છે. એપોજી 2S ટ્રાન્સમીટર 600 મીટર લેસર રેન્જ ધરાવે છે. આ ઘરમાં ઉત્પાદિત ટ્રાન્સમીટરને બજારમાં તમામ પ્રકારની સિસ્ટમો સાથે કામ કરવા માટે ખૂબ ભલામણ કરવામાં આવે છે.</p>
          <!-- <div class="row  mt-3">
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              <ul class="specificationList">
                <li class="headList">Apogee 2S-Dual SI ટ્રાન્સમીટર</li>
                <li class="bgGreen"></li>
                <li class="p-0">
                  <table class="table table-bordered mb-0">
                    ...
                    <tr>
                      <td>લેસર તરંગલંબાઇ</td>
                      <td> 635nm</td>
                    </tr>
                    <tr>
                      <td>સ્તરીકરણ પદ્ધતિ </td>
                      <td>  આપોઆપ સ્તરીકરણ</td>
                    </tr>
                    <tr>
                      <td>કાર્યકારી શ્રેણી</td>
                      <td>600 મી</td>
                    </tr>
                    <tr>
                      <td>ચોકસાઈ</td>
